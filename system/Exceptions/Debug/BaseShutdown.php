...
function handler( $errNo, $errMsg, $errFile, $errLine ) {
     ...
     */
    error_log(preg_replace('/&(?!#?[a-z0-9]+;)/', '&amp;', $message). PHP_EOL, 3, $filePath);

    //check if the error number returned is also defined in the E_FATAL constant
    //if envionment is production, redirect to predifined error page
    if( ($errNo & E_FATAL) && DEV == false ) {
    ...
    <head profile="http://www.w3.org/2005/10/profile">
        <meta charset="UTF-8">
        <title>Gliver PHP - MVC Framework</title>
